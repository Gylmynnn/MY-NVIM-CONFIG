...
M.general = {
   ...
   n = {
      ...
      ["<leader>fr"] = {"<cmd> FlutterRun <CR>", "Run Flutter"},
      ["<leader>fd"] = {"<cmd> FlutterDevices <CR>", "Device Flutter"},
      ["<leader>fe"] = {"<cmd> FlutterEmulators <CR>", "Emulators Flutter"},
      ["<leader>fre"] = {"<cmd> FlutterReload <CR>", "Reload Flutter"},
